    ...
    return (
        <div >
            <div style={{ display: "flex", justifyContent: "space-around", lineHeight: "30px", padding: "2%" }}>
                <div style={{ height: "328px", width: "584px" ,borderRadius:"25px"}}>
                    <video src="https://vecros.com/static/media/jetpix_at_demo.71abd02da894336d8720.mp4"  width="584" height="328"  loop="true" autoplay="autoplay" controls muted/>
